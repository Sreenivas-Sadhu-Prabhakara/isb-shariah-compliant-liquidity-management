package com.bank.islamic.shariahcompliantliquiditymanagement.model;
...
/**
 * The BIAN control record for this service domain: "Liquidity Position Management Plan".
 *
 ...
 * to its asset type (Liquidity Position). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Liquidity Position Management Plan";
